...
[assembly: Permission( Name = "ru.nwdgroup.taxiauction.permission.C2D_MESSAGE" )] //, ProtectionLevel = Android.Content.PM.Protection.Signature)]
[assembly: UsesPermission( Name = "ru.nwdgroup.taxiauction.permission.C2D_MESSAGE" )]
...
namespace TaxiAuction
{
	...
	[IntentFilter( new string [ ] { GCMConstants.INTENT_FROM_GCM_MESSAGE }, Categories = new string [ ] { "ru.nwdgroup.taxiauction" } )]
	[IntentFilter( new string [ ] { GCMConstants.INTENT_FROM_GCM_REGISTRATION_CALLBACK }, Categories = new string [ ] { "ru.nwdgroup.taxiauction" } )]
	[IntentFilter( new string [ ] { GCMConstants.INTENT_FROM_GCM_LIBRARY_RETRY }, Categories = new string [ ] { "ru.nwdgroup.taxiauction" } )]
	public class PushHandlerBroadcastReceiver : PushHandlerBroadcastReceiverBase<PushHandlerService>
	{
		...
		public static string [ ] SENDER_IDS = new string [ ] { "1004097316256" };

		public const string TAG = "TaxiAuction-GCM";
	}
	...
	public class PushHandlerService : PushHandlerServiceBase
	{
		...
		protected override void OnRegistered (Context context, string registrationId)
		{
			...
			UserInfo.PushId = registrationId;
		}
		...
		protected override void OnMessage (Context context, Intent intent)
		{
			...
			var message = msg.ToString( ).Remove( msg.ToString( ).IndexOf( ';' ) ).Remove( 0, 8 );

			CreateNotification("ТаксиАукцион", message);
		}
		...
		void CreateNotification(string title, string desc)
		{
			...
			var uiIntent = new Intent(this, typeof(AuthActivity));
